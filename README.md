...
| **Profil jusqu'à l'arrivée** | graphique | Tout le profil restant sur une seule bande, à échelle non linéaire : les deux premiers kilomètres prennent près de la moitié de la largeur, le reste se comprime derrière. Les graduations, inégalement espacées, disent la compression. |
...
core/                        module JVM pur, testable — aucune dépendance Android
  ...
  Fisheye.kt                 l'échelle qui dilate le proche et comprime le lointain
