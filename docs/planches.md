...
| **C** | Minicarte | Cap en haut, coureur fixe aux quatre cinquièmes de la hauteur. Fond de carte hors ligne, tracé cerné de noir, chevrons bornés aux prochaines centaines de mètres. Le tracé se coupe à l'aplomb du coureur, projeté sur le segment et non sur le sommet le plus proche : sans quoi la coupure — et le premier chevron avec elle — attendait le coureur puis sautait au sommet suivant. Hors itinéraire, le ruban et ses chevrons passent au rouge, et les chevrons ne sont plus bornés : la borne se comptait depuis un point qui n'existe plus. |
